...
class DouyinFollowTool(DouyinJsApiTool):
    ...
    async def follow_user(
        ...
        *,
        ...
        async with pool.tenant_context(
            ...
            result = await self._follow_on_page(
                page,
                sec_uid=sec_uid,
                user_id=user_id,
                username=username,
    ...
    async def _follow_on_page(self, page, *, sec_uid: str, user_id: str, username: str) -> dict:
    ...
    async def _commit_follow(
        ...
        *,
        ...
        if follow_status_before in {1, 2}:
            return {
                "ok": True,
                "skipped": True,
        ...
        body = urlencode({"type": "1", "user_id": user_id, "sec_user_id": sec_uid})
        last_error = "follow_failed"
