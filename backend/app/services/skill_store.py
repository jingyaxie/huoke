...
DEFAULT_GLOBAL_SKILLS: list[dict] = [
    ...
    {
        "id": "xhs-keyword-comments",
        "name": "小红书关键词笔记+评论（已验证）",
        "description": "探索页预热→搜索笔记→抓评论，一键 builtin，PlaywrightPool 持久 Profile",
        "type": "builtin",
        "enabled": True,
        "scope": "global",
        "parameters": [
            {"name": "keyword", "type": "string", "description": "搜索关键词", "required": True},
            {"name": "limit", "type": "integer", "description": "抓取笔记数量", "required": False, "default": 3},
            {"name": "days", "type": "integer", "description": "最近天数筛选", "required": False, "default": 3},
            {"name": "region", "type": "string", "description": "地区筛选，可选", "required": False},
            {"name": "show_browser", "type": "boolean", "description": "使用 VNC 可见浏览器", "required": False, "default": False},
        ],
        "content": "已验证生产链路，直接调用即可。",
        "actions": [],
